      ...
      <div class="section__container page-doctors__container">
        ...
        <div class="section__search">
          <form class="section__search-form">
            <input class="section__search-input" id="page-doctors__search-input" type="search" name="q" placeholder="Поиск по ФИО и специальности" spellcheck="true" autocomplete="off">
          </form>
        </div>
        <div class="section__items page-doctors__items">
          ...
          ?>
            <div class="page-doctors__item">
              ...
              <div class="page-doctors__btn" id="docBtn<?php the_field('doctors_id', $page->ID); ?>">записаться</div>
              <script>
                docBtn<?php the_field('doctors_id', $page->ID); ?>.onclick = function() {
                  var docId = '<?php the_field('doctors_id', $page->ID); ?>';
                }
              </script>
              <a class="page-doctors__item-link" href="<?php echo get_page_link($page->ID); ?>">
