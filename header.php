...
<body>
  ...
  <header class="header">
    <div class="header__top-adres-container">
      <div class="header__wrap">
        <a class="header__top-adres" href="#footer">
          <i class="fas fa-map-marker-alt"></i>посмотреть адреса клиник
        </a>
      </div>
    </div>
    <div class="header__wrap">
      <div class="header__menu-container">
        <div class="header__logo">
          <a class="header__logo-link header__logo-link--desktop" href="<?php echo home_url(); ?>"><img
              src="<?php bloginfo('template_url'); ?>/assets/img/logo.png" alt="logo"></a>
          <a class="header__logo-link header__logo-link--mobile" href="<?php echo home_url(); ?>"><img
              src="<?php bloginfo('template_url'); ?>/assets/img/logo_m.png" alt="logo"></a>
        </div>
        <div class="header__menu-block">
          ...
          <div class="header__menu">
            ...
            <a class="burger__call burger__icon-phone"
          ...
          <div class="header__buttons-block">
            ...
            <a class="header__btn header__call header__icon-phone"
              href="tel:<?php echo $all_options['number_phone']; ?>"><?php echo $all_options['number_phone']; ?></a>
  ...
  <div class="side-form vacancy" id="form__vacancy">
    <div class="side-form__inner">
      ...
      <a class="side-form__link" href="<?php echo home_url(); ?>/vacancy">Посмотреть все вакансии</a>
    </div>
    <div class="side-form__bg"></div>
  </div>
  <div class="bvi-btn">
