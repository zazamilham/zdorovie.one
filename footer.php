		  ...
		  <div class="wrap">
		    <div class="section__container footer__container">
		      ...
		      <div class="footer__contacts">
		        ...
		        <a class="footer__clinic-tel" href="tel:<?php echo $all_options['number_phone']; ?>">
		          <i class="fas fa-phone-alt"></i>
		          <?php echo $all_options['number_phone']; ?>
		        </a>
		        <a class="footer__clinic-email" href="mailto:<?php echo $all_options['email_to_send']; ?>">
		          <i class="fas fa-envelope"></i>
		          <?php echo $all_options['email_to_send']; ?>
		        </a>

		        <a class="footer__clinic-media" target="_blank" href="<?php echo $all_options['vk_link']; ?>">
		          <i class="fab fa-vk"></i>мы Вконтакте
		        </a>
		        <a class="footer__clinic-media" target="_blank" href="<?php echo $all_options['insta_link']; ?>">
		          <i class="fab fa-instagram"></i>мы в Instagram
		        </a>

		      </div>
		      <div class="footer__map">
		        <a class="footer__map-link"
		          href="https://2gis.ru/novosibirsk/branches/141274359490806?m=83.041497%2C54.99563%2F14.21" target="_blank">
		          <p>открыть карту</p>
		      ...
		      <div class="footer__media">
		        <div class="footer__media-watermark">ИМЕЮТСЯ ПРОТИВОПОКАЗАНИЯ НЕОБХОДМА КОНСУЛЬТАЦИЯ ВРАЧА</div>
		      </div>
		      ...
		      <div class="footer__dev">
		        <a class="footer__dev-link" target="_blank" href="http://fufuter.ru/">Постарались и разработали сайт</a>
		      </div>
		    </div>
		  </div>
		</section>
...
(function(a, b, c) {
  try {
    function f() {
      ...
      g.type = 'text/javascript', g.async = !0, g.src = '//widget.webica.pro/code/loader.js?id=' + c, h.parentNode
        .insertBefore(g, h)
    }
