  ...
  <div class="wrap">
    <div class="section__container services__container">
      ...
      <div class="section__items services__items">
        <a class="link services__item-link item__link--analyzes" href="<?php echo get_home_url(); ?>/services#analyzes">
          <div class="services__item">
            <img class="services__item-img"
              src="<?php bloginfo('template_url'); ?>/assets/theme/img/services__microscope.svg" alt="Анализы">
        ...
        <a class="link services__item-link item__link--diagnostics"
          ...
          <div class="services__item">
            <img class="services__item-img"
              src="<?php bloginfo('template_url'); ?>/assets/theme/img/services__diagnostics.svg" alt="Диагностика">
        ...
        <a class="link services__item-link item__link--adults" href="<?php echo get_home_url(); ?>/services#adults">
          <div class="services__item">
            <img class="services__item-img"
              src="<?php bloginfo('template_url'); ?>/assets/theme/img/services__pregnancy.svg" alt="Взрослые">
        ...
        <a class="link services__item-link item__link--sales" href="<?php echo get_home_url(); ?>/services/#sales">
          <div class="services__item">
            <img class="services__item-img"
  ...
  <div class="wrap">
    <div class="section__container about__container">
      <div class="section__description">
        ...
        <?}?>
        <a href="<?php echo get_home_url(); ?>/about" class="link section__link"><i class="fas fa-angle-right"></i>о
          клинике</a>
      </div>
  ...
  <div class="wrap">
    <div class="section__container doctors__container">
      <div class="section__description">
        ...
        <?}?>
        <a class="link section__link" style="margin-right: 30px;" href="<?php echo get_home_url(); ?>/doctors"><i
            class="fas fa-angle-right"></i>к
          списку врачей</a>
        ...
        <div class="news__box">
          ...
          <div class="news__calltodirector">
            ...
            <div class="calltodirector__btn-box">
              <a class="link calltodirector__btn" href="tel:<?php echo $all_options['dir_number_phone']; ?>">ПОЗВОНИТЬ
                ДИРЕКТОРУ</a>
            </div>
          </div>
        </div>
