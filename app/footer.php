		  ...
		  <div class="wrap wrap--footer">
		    ...
		    <div class="section__container footer__container two">
		      ...
		      <div class="footer__media">
		        <div class="footer__media-watermark">ИМЕЮТСЯ ПРОТИВОПОКАЗАНИЯ, НЕОБХОДИМА КОНСУЛЬТАЦИЯ СПЕЦИАЛИСТА.</div>
		      </div>
		      ...
		      <div class="footer__dev">
		        ...
		        <a class="link footer__dev-link" target="_blank" href="http://fufuter.ru/">Постарались и разработали сайт</a>
		      </div>
		    </div>
		  </div>
		</section>
