        ...
        <div class="section__description">
          ...
          <div class="page-services__link-container">
            <div class="page-services__inner">
              <a class="page-services__link page-services__link-1" href="#analyzes"><img class="page-services__link-img"
                  src="<?php bloginfo('template_url'); ?>/assets/img/page-services__microscope.svg"> Анализы</a>
              <a class="page-services__link page-services__link-2" href="#diagnostics"><img
                  class="page-services__link-img"
                  src="<?php bloginfo('template_url'); ?>/assets/img/page-services__diagnostics.svg">
                Диагностика</a>
              <a class="page-services__link page-services__link-3" href="#adults"><img class="page-services__link-img"
                  src="<?php bloginfo('template_url'); ?>/assets/img/page-services__pregnancy.svg"> Взрослые</a>
              <a class="page-services__link page-services__link-4" href="#kids"><img class="page-services__link-img"
                  src="<?php bloginfo('template_url'); ?>/assets/img/page-services__baby-boy.svg"> Дети</a>
              <a class="page-services__link page-services__link-5" href="#reproductive-health"><img
                  class="page-services__link-img"
                  src="<?php bloginfo('template_url'); ?>/assets/img/page-services__pregnancy.svg">
        ...
        <div class="section__items page-services__items">
            ...
            <div class="page-services__item-box">
              ...
              <div class="page-services__category">
                <div class="category__description <?php if ($i == '374') { ?>category__description--active <?php } ?>">
                  ...
                  <a href="<?php echo get_page_link($page->ID); ?>"><span>Узнать больше</span><i
          ...
          <div class="page-services__item" id="page-services__item--3">
            ...
            <div class="page-services__item-box">
              ...
              <div class="page-services__category">
                <div
                  class="category__description <?php if ($i == '423' || $i == '340' || $i == '344' || $i == '377' || $i == '391' || $i == '326' || $i == '348') { ?>category__description--active <?php } ?>">
                  <?php
                    foreach ($prices_catalogs as $c) {
                      $cat_id = $c->id;
                      if ($cat_id == $i) { ?>
          ...
          <div class="page-services__item" id="page-services__item--4">
            ...
            <div class="page-services__item-box">
              ...
              <div class="page-services__category">
                <div
                  class="category__description <?php if ($i == '391' || $i == '394' || $i == '410' || $i == '393' || $i == '377' || $i == '298') { ?>category__description--active <?php } ?>">
                  <?php
                    foreach ($prices_catalogs as $c) {
                      $cat_id = $c->id;
                      if ($cat_id == $i) { ?>
