      ...
      <div class="section__container reviews__container">
        ...
        <div class="section__items reviews__items">
          ...
          <div class="reviews__item">
            <a class="reviews__item-link" href="<?php the_field('link_flamp'); ?>">
              <img class="reviews__img" src="<?php bloginfo('template_url'); ?>/assets/img/reviews__flamp.svg" alt="Flamp">
          ...
          <div class="reviews__item">
            <a class="reviews__item-link" href="<?php the_field('link_2gis'); ?>">
              <img class="reviews__img" src="<?php bloginfo('template_url'); ?>/assets/img/reviews__2gis.svg" alt="2gis">
              <div class="reviews__item-desc">
                <div class="reviews__item-rate">
          ...
          <div class="reviews__item">
            <a class="reviews__item-link" href="<?php the_field('link_yandex'); ?>">
              <img class="reviews__img" src="<?php bloginfo('template_url'); ?>/assets/img/reviews__yandex.svg" alt="Yandex">
              <div class="reviews__item-desc">
                <div class="reviews__item-rate">
          ...
          <div class="reviews__item">
            <a class="reviews__item-link" href="<?php the_field('link_pro'); ?>">
              <img class="reviews__img" src="<?php bloginfo('template_url'); ?>/assets/img/reviews__pro.svg" alt="Продокторов">
              <div class="reviews__item-desc">
                <div class="reviews__item-rate">
