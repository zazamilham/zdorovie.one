      ...
      <div class="wrap">
        <div class="section__container page-blog__container">
          <div class="section__description">
            <div class="section__title page-blog__title">публикации с тегом: <span><?php single_term_title(); ?></span></div>
          </div>
                    ...
                    <a class="page-blog__item-link" href="<?php the_permalink(); ?>">
                      <div class="page-blog__item">
                        ...
                        <div class="page-blog__item-box">
                          <div class="page-blog__item-type"><?php $category = get_the_category(); echo $category[0]->cat_name; ?></div>
