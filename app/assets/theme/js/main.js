jQuery(function ($) {
    ...
    //кнопка "узнать больше" в услугах
    $(".category__description .link, .category__description-child .link").click(
        function (event) {
    ...
    if ($(".page-doctors__item")) {
        ...
        $(".page-doctors__item").mouseleave(function () {
            $(".page-doctors__item .page-doctors__select-box").removeClass(
                "active"
            );
        });
    }
...
if (document.querySelector("#page-doctors__search-input")) {
    document.querySelector("#page-doctors__search-input").oninput =
        function () {
            ...
            if (val != "") {
                doctorName.forEach(function (elem) {
                    ...
                    if (elem.innerText.search(val) == -1) {
                        elem.closest(".page-doctors__item").classList.add(
                            "page-doctors__item-hide"
                        );
                        elem.innerHTML = elem.innerText;
                    } else {
                        elem.closest(".page-doctors__item").classList.remove(
                            "page-doctors__item-hide"
                        );
