<?php 
/*
Template name: Запись Блога/Акции с картинкой ввиде банера
...
<section class="section page-blog-note__slide-cover" style="object-position: <? the_field('cover_position') ?>%">
    ...
    <? if (has_post_thumbnail()) {the_post_thumbnail('blog-page_cover_slide', array('class' => "page-blog-note__slide-cover-img"));}?>
    ...
    <div class="wrap wrap--blog">
        <div class="section__container">
            <div class="section__description">
                ...
                <a href="<?php echo get_home_url(); if ($category[0]->term_id == 4 ) {echo '/services/#sales';} else {echo '/blog';}?>"
                    class="link section__link <? 
        ...
        <div class="section__container page-blog-note__container">
            <div class="section__items page-blog-note__items slide-cover">
                <div class="page-blog-note__item">
                    ...
                    <div class="page-blog-note__item-date"><?php the_field('sale_start') ?> -
                        <?php 
                          the_field('sale_end');
                    ...
                    <div class="page-blog-note__item-date"><?php the_date('j F Y'); ?></div>
                    <?php
                      }
                    ?>
